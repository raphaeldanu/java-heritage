        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="residence">
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <div class="d-flex justify-content-around align-items-center">
                    ...
                    <a href="{{ route('residences.edit', ['employee' => $employee]) }}" class="btn bg-warning"><i class="fas fa-edit"></i></a>
                    @endcan
                    ...
                    <form method="post" action="{{ route('residences.destroy', ['employee' => $employee]) }}">
                      <x-adminlte-modal id="modalDelete{{ $employee->residence->id }}" title="Delete Role" theme="teal"
            ...
            <div class="d-flex justify-content-center">
              ...
              <a href="{{ route('residences.create', ['employee' => $employee]) }}" class="btn bg-teal">Add Residence Address</a>
              @else
              <dl>
