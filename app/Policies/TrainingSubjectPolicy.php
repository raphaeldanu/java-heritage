...
class TrainingSubjectPolicy
{
    ...
    {
        return $user->can('view-all-training-subjects');
    }
    ...
    {
        return $user->can('view-training-subjects');
    }
    ...
    {
        return $user->can('create-training-subjects');
    }
    ...
    {
        return $user->can('update-training-subjects');
    }
    ...
    {
        return $user->can('delete-training-subjects');
    }
}
